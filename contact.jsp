...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
     <h1  style="text-align:center">GINATILAN EMERGENCY CONTACT NUMBERS</h1>
      <br>
      <div class="fakeimg"> <img src="img/MDRRMO.jpg" style="width:100%"></div>
    ...
    <div class="card">
 	<h2><a>About</a></h2> 
 		...
 		<a href="GinatilanMap.jsp"><i class="fa fa-flag" style="color:red"></i><i style="color:black">
 		Ginatilan Map</i></a><br><br>
 		<a><i class="fa fa-check-circle-o" style="color:green"></i>Contact Us</a></h3>
