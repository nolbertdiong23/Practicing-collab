...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
     ...
     <h1  style="text-align:center">ENGINEER</h1>
      <br>
      <br>
      <div id="link">
        <a href="financialpdf/OBO - Processing and Issuance Certificate of Occupancy Application(1).pdf" target="_blank">OFFICE OF THE BUILDING OFFICIAL - Processing and Issuance Certificate of Occupancy Application</a>
      <br>
      <br>
      <br>
     <a href="financialpdf/OBO - Processing and Issuance of Building Permit Application revised.pdf" target="_blank">OFFICE OF THE BUILDING OFFICIAL - Processing and Issuance of Building Permit Application</a>
      <br>
      <br>
      <br>
      <a href="financialpdf/OBO - Processing Fencing Permit Application.pdf" target="_blank">OFFICE OF THE BUILDING OFFICIAL - Processing Fencing Permit Application</a>
      </div>
       </div>
      </div>
    ...
    <div class="card">
 	<h2><a>Services</a></h2> 
		...
		MTO Frontline</i></a><br><br>
		
		<a><i class="fa fa-check-circle-o" style="color:green"></i><i style="color:black">
		Engineering</i></a><br><br>
