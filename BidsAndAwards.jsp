...
<div class="row">
   <div class="leftcolumn">
    <div class="card">
       <h1  style="text-align:center">BIDS AND AWARDS</h1>
      <br>
      <br>
      <br>
       <div class="fakeimg"> <img src="img/undercons.jpg" style="width:100%"></div>
       <br>
       <br>
       <br>
      </div>
    ...
    <div class="card">
 	<h2><a>Governance</a></h2> 
 		<h3><a href="FianancialTransparency.jsp"><i class="fa fa-flag" style="color:red"></i><i style="color:black">
 		Financial Transparency</i></a><br><br>
