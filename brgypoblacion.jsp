...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
<div class="logo"> <img src="img/poblacion.png"> <h1>BARANGAY POBLACION</h1>
    </div>
    <br>
        <br>
...
AND PROMOTION OF THE WELFARE OF WOMEN AND CHILDREN AND TO ENHANCE THE LIVING CONDITIONS OF THE FARMERS AND FISHERMEN.</p>
	<br>
	<br>
	<h2  style="text-align: center">POBLACION BARANGAY HALL</h2>
	<div class="fakeimg"> <img src="img/brgy.png" style="width:100%; text-align:center;"></div>
	<br>
	<br>
	
	<h2 style="text-align: center">POBLACION BARANGAY OFFICIALS</h2>
	<div class="fakeimg"> <img src="img/pob1.png" style="width:100%"></div>
	<br>
	<br>
	<br>
    ...
    <div class="card">  
 	<h2><a>Your Officials</a></h2> 
 		...
 		<i class="fa fa-group" style="color:#805500; font-size:30px"></i>
 		 	<h3><a><i class="fa fa-check-circle-o" style="color:green"></i>Barangay Poblacion</a>
 		 	...
 		 	<a href="brgypalanas.jsp">Barangay Palanas</a>
