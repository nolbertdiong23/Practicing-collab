...
<title>Economic Profile here in Ginatilan</title>
...
<div class="row">
  ...
  <h2><a>Business and Economy</a></h2> 
 		<h3><a><i class="fa fa-check-circle-o" style="color:green"></i>Economic Profile</a><br><br>
 		...
 		<a href="DoingBusinessinGinatilan.jsp"><i class="fa fa-flag" style="color:red"></i><i style="color:black">
 		Doing business in Ginatilan</i></a><br><br></h3>
