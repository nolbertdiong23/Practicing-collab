...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      ...
      <div class="fakeimg"><img src="img/undercons.jpg" class="pictures" style="width:100%">  </div>
      <ol class="withroman">
   <h3 align="justify"><li>Maternal and Child Health Services:</li></h3>
   <br>
		<h4 align="justify">MATERNAL:</h4>
	
		<p align="justify">1. Prenatal</p>
		<p align="justify">2. Delivery</p>
		<p align="justify">3. Postnatal</p>
		<h4 align="justify">CHILD:</h4>
			<p align="justify">1. Immunization</p>
			<p align="justify">2. Newborn Screening</p>
			<p align="justify">3. Operation Timbang</p>
			<p align="justify">4. Micronutrient Supplementation</p>
			<p align="justify">5. Deworming</p>
			<p align="justify">6. Micronutrient Powder</p>
		
		<h3 align="justify"><li>Laboratory Services.</li><br>
		<li>Dental Services.</li><br>
		<li>Consultation.</li><br>
		<li>National Tubercolosis Program.</li><br>
		<li>Family Planning.</li><br>
		<li>Environmental Sanitation.</li></h3>
		</ol>
</div>
      </div>
    ...
    <div class="card">
 	<h2><a>Services</a></h2> 
 		...
 		<a><i class="fa fa-check-circle-o" style="color:green"></i>Health</a><br><br>
		...
		<a href="Agriculture.jsp"><i class="fa fa-flag" style="color:red"></i><i style="color:black">
		Agriculture</i></a><br><br>
