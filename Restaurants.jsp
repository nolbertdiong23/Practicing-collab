...
<title>Restaurants here in Ginatilan</title>
...
<div class="row">
 <div class="leftcolumn">
    <div class="card">
      <h1  style="text-align:center">RESTAURANTS IN GINATILAN</h1>
      <br>
      <br>
       <br>
      <br>
      <br>
      <br>
      <h2 align="justify">LIVE OAK PENSION HOUSE</h2>
      <p align="justify">Address: Poblacion, Ginatilan, Cebu</p>
      <br>
       <br>
      <br>
      <br>
      ...
      <br>
      <br>
      <h2 align="justify">MK's RESTAURANTS</h2>
      <p align="justify">Address: San Roque, Ginatilan, Cebu</p>
      <br>
      <br>
    ...
    <div class="card">
 <h2><a>TOURISM</a></h2>  
 		<h3><a href="TourismAndHeritage.jsp"><i class="fa fa-flag" style="color:red"></i><i style="color:black">
 		Tourism and Heritage Site</i></a><br><br>
 		...
 		<a><i class="fa fa-check-circle-o" style="color:green"></i>Restaurants</a><br><br></h3>
 		 </div>
 		 </figure>
 	</div>
 	</div>
