...
<title>Doing Business in Ginatilan</title>
...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      <h2>Doing Business in Ginatilan</h2>
      <h5> </h5>
      ...
      <div class="rightcolumn">
       <figure class="swing">
    <div class="card">
  <h2><a>Business and Economy</a></h2> 
 		<h3><a href="EconomicProfile.jsp"><i class="fa fa-flag" style="color:red"></i><i style="color:black">
 		Economic Profile</i></a><br><br>
 		<a href="BusinessOpportunities.jsp"><i class="fa fa-flag" style="color:red"></i><i style="color:black">
 		Business Opportunities</i></a><br><br>
 		<a><i class="fa fa-check-circle-o" style="color:green"></i>Doing business in Ginatilan</a><br><br></h3>
